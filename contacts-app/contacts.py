...
def contact_form(contact=None, action="/contacts/create"):
    ...
    delete_button = Button(
        UkIcon("trash", cls=(TextT.error, "text-whmr-2")), "Delete", cls=ButtonT.destructive, 
        hx_get=f"contacts/{contact.id}/delete/confirm", hx_target="#modal-container"
    ...
    return Form(
        ...
        Grid(
            ...
            Div(
                ...
                P(errors.get("email",""), cls=(TextT.error, TextT.sm,"mt-1") if "email" in errors else None)), cols=2),
